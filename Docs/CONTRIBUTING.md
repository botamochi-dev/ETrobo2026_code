...
既に設定している場合もありますが、この情報は全世界に公開されてしまうため、プライバシー護の観点から大学のメールアドレスなどを設定している場合にはGitHubが提供するダミーのメーアドレスに変更しておきましょう。
...
3. Keep my email addresses private にチェックを入れると、そのすぐ下に I+username@users.noreply.github.com という形式のアドレスが表示されます。
